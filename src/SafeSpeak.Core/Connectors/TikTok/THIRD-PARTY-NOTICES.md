# TikTok direct experiment

The native transport and bounded wire decoder use protocol field mappings and
connection framing documented by PirateTok/live-cs, commit
...
Copyright (C) 2026 Zmole Cristian
