...
| Current release baseline | 1.0.3.0 |
...
- Standardized the desktop, GitHub, and Microsoft Store package version on 1.0.3.0 for the replacement submission; the dormant mobile test track retains its independent pre-release version.
